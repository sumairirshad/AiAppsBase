...
export const megaMenus: MegaMenu[] = [
  {
    ...
    columns: [
      ...
      },
      {
        title: 'Categories',
        items: [
          { label: 'AI Projects', href: '/products?category=ai', icon: 'Bot' },
          { label: 'SaaS Boilerplates', href: '/products?category=saas', icon: 'Layers' },
          { label: 'Templates', href: '/products?category=templates', icon: 'LayoutTemplate' },
          { label: 'Components', href: '/products?category=components', icon: 'Component' },
          { label: 'Dashboards', href: '/products?category=dashboards', icon: 'LayoutDashboard' },
          { label: 'Chrome Extensions', href: '/products?category=extensions', icon: 'Puzzle' },
        ],
      },
    ],
  },
